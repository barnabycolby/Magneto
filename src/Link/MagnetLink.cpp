...
// Constructor
MagnetLink::MagnetLink(string link)
{
...
string MagnetLink::getInfoHash()
{
	return this->infoHash;
}

string MagnetLink::getDisplayName()
{
	return this->displayName;
}

queue<string>* MagnetLink::getTrackers()
{
	return &(this->trackers);
}

bool MagnetLink::containsEqualOrAmpersand(string str)
{
